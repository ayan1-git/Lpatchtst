...
GAMMA0      = 0.25       # per-sample entropy weight (pushes confident bits)
GAMMA       = 5.0        # codebook entropy weight  (pushes utilization) ← CRITICAL
ZETA        = 0.05        # overall entropy scale
